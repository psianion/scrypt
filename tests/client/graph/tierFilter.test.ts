...
describe("tierFilter", () => {
  ...
  test("filterEdgesByTier keeps only enabled tiers", () => {
    const edges: SnapshotEdge[] = [
      { source: "a", target: "b", tier: "connected", reason: null, rel_type: null },
      { source: "a", target: "c", tier: "mentions", reason: null, rel_type: null },
      { source: "a", target: "d", tier: "semantically_related", reason: null, rel_type: null },
    ];
